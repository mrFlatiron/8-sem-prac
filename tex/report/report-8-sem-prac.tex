...
По схеме Соколова стабилизация происходит медленнее, чем в схеме с центральными разностями. Также при меньшей вязкости газа стабилизация по обоим схемам медленнее.
%\bibliography{main}
